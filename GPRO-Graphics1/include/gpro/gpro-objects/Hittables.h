...
/*
    ...
    Modified because : ___Needed to Add the hittable_list class provided in Peter Shirley's
    "Ray Tracing in one Weekend" in order to give correct information of when the object has been hit_________
*/
#ifndef HITTABLES
#define HITTABLES
